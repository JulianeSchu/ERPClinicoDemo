...
namespace ERP.API.Migrations
{
    ...
    [Migration("20250623173433_CreateProcedimentoProfissional")]
    partial class CreateProcedimentoProfissional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.ProcedimentoProfissional", b =>
                {
                    b.Property<Guid>("ProcedimentoId")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ProcedimentosProfissionais");
                });
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.ProcedimentoProfissional", b =>
                {
                    b.HasOne("ERP.API.Domain.Models.Procedimento", "Procedimento")
                        .WithMany("ProcedimentosProfissionais")
                        .HasForeignKey("ProcedimentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.Procedimento", b =>
                {
                    ...
                    b.Navigation("ProcedimentosProfissionais");
                });
