...
namespace ERP.API.Migrations
{
    ...
    [Migration("20250804005610_AlteraPacienteConvenioParaDataVinculo")]
    partial class AlteraPacienteConvenioParaDataVinculo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.Agendamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.Paciente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.Agendamento", b =>
                {
                    b.HasOne("ERP.API.Domain.Models.Convenio", "Convenios")
                        .WithMany("Agendamentos")
                        .HasForeignKey("ConvenioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ERP.API.Domain.Models.Paciente", "Paciente")
                        .WithMany("Agendamentos")
            ...
            modelBuilder.Entity("ERP.API.Domain.Models.AgendamentoProcedimento", b =>
                {
                    b.HasOne("ERP.API.Domain.Models.Agendamento", "Agendamento")
